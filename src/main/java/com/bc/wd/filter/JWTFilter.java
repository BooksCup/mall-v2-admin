...
import com.bc.wd.ream.JWTToken;
            ...
            try {
                ...
                if (e instanceof AuthorizationException) {
                    ...
                    if (stringRedisTemplate.hasKey(key)) {
                        ...
                        String newToken = JWTUtil.sign(userId.toString(), secret);
                        stringRedisTemplate.opsForValue().set(key, newToken);
                        stringRedisTemplate.expire(key, 2 * tokenExpireTime, TimeUnit.MINUTES);
...
//        result.setMsg("授权失败，禁止访问");
        ...
        printWriter.append(objectMapper.writeValueAsString(new BaseResult(403, "授权失败，禁止访问", "")));
        return false;
    }
